...
//      case "3" => executePathQuery(query, g, allGraphNbrs, 500, 3)
...
//            edge.toString(entityLabel,maxEntityLabelSize)).foldLeft("")((edge1, edge2)=> edge1+","+edge2)
...
//        foldLeft("")((edge1, edge2)=> edge1+","+edge2)
...
//     val allPaths = PathRanking.runPregel(src, dest, gExtended, filterObj, maxPathSize, EdgeDirection.Either)
...
//              }
//            }).
//            reduce((edge1String, edge2String) => edge1String + "," + edge2String)).
...
//  /*  
//    val verticesWithEdgeTypeAndLabel = allGraphNbrs.mapValues(nodeNbrs => 
//   //   nodeNbrs.filter(edge => edge._3 == KGraphProp.edgeLabelNodeType || 
//   //       edge._3 == KGraphProp.edgeLabelNodeAlias)
//            nodeNbrs.filter(edge => edge._3 == KGraphProp.edgeLabelNodeType)
//    ).filter(nodesWithFilteredEdges => nodesWithFilteredEdges._2.size > 0)
//    */
