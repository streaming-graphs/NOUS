 ...
 *
 */
class PatternInstance(var instance: scala.collection.immutable.Set[(Int, Int)])
  ...
  def canEqual(other: Any) = {
	  other.isInstanceOf[gov.pnnl.aristotle.algorithms.mining.datamodel.PatternInstance]
	}
  
  override def equals(other: Any) = {
	  other match {
	    case that: gov.pnnl.aristotle.algorithms.mining.datamodel.PatternInstance => 
	      {
	        var result = true;
	        ...
	        val other_instances  : scala.collection.immutable.Set[(Int, Int)] = 
	          other.asInstanceOf[gov.pnnl.aristotle.algorithms.mining.datamodel.PatternInstance].get_instacne
