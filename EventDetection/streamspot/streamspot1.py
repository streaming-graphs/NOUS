...
# Do this once using a bash script and store the graphs to files
...
for gid in range(0, 600):
    ...
    with open(fname, 'rb') as f:
        for line in f:
            ...
            # Ignore the most popular ones
            if edge_str in ['awe', 'auc', 'bGc', 'aGe', 'avc', 'aHe']:
                continue
            # Add an edge in both directions with a ** for the reverse direction
