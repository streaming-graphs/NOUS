# This code is attempting to learn an RNN model for finding the vector representation of the Graph nodes
...
class RNNSearch():
	...
	def load_data(self):
		Node_IDs_fname = 'yago2data/vertexDictionary.out'
...
def test_RNNSearch():
    ...
    with tf.Session() as session:
		...
		#print("Clustering completed, finding each node's cluster ,membership\n")
		# assign each sample to a cluster
		#idx_array,_ = vq(features_vec, cluster_centroid)
		
		# Writing the cluster-ids and cluster centorid vectors in output files
		#f = open("yagoGraph2VecSearch_idx_cluster_5000.txt", "w")
		#pk.dump(idx_array, f)
		#f.close()
		
		#f = open("yagoGraph2VecSearch_Cluster_Centroids_5000.txt", "w")
